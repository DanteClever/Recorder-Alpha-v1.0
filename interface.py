...
root.title("Rec AlphaRP v1.0")
root.geometry("800x400+200+100")
#--
ico = Image.open('a.ico')
...
#header = canvas.create_text(400.0, 91.0, text="Rec AlphaRP  ", fill="#ECE8EF", font=("Roboto-Bold", int(30.0)))
...
switch = tkinter.Scale(from_=60, to=200, orient=tkinter.HORIZONTAL, length=200, activebackground="#C25993"
...
info = canvas.create_text(400.0, 342.5, text="شروع  ", fill="Black", font=("Roboto-Medium", int(16.0)))
